	...
	private void tourner() {
		if (this.demande != null) { // une touche à été pressée
			...
			if (this.direction == Direction.UP || this.direction == Direction.DOWN) {
				if (this.demande == Direction.RIGHT) { // la touche droite à été pressée
					// le serpent tourne à droite
					this.direction = Direction.RIGHT;
				} else if (this.demande == Direction.LEFT) { // la touche gauche à été pressée
					// le serpent tourne à gauche
					this.direction = Direction.LEFT;
				}
			} else { // le serpent va vers la droite ou la gauche
				if (this.demande == Direction.UP) { // la touche haut à été pressée
					// le serpent tourne vers le haut
					this.direction = Direction.UP;
				} else if (this.demande == Direction.DOWN) { // la touche bas à été pressée
